...
* 만약 붉은색(약물 반응군) 점들과 푸른색(저항군) 점들이 서로 섞이지 않고 뚝 떨어져 두 개의 섬(Cluster)을 형성하고 있다면, 두 그룹은 생물학적으로 완전히 다른 특성을 지니고 있음을 명백하게 증명하는 것입니다.
...
* **해석**: 선들이 왼쪽으로 가면서 대부분 0의 높이로 사라지지만, 끝까지 0으로 죽지 않고 살아남아 뻗어나가는 굵은 선들이 있습니다. 이 선들이 바로 **"수만 개의 유전자 중에서도 환자의 예후를 예측하는 데 가장 중요한 최정예 바이오마커"**들입니다.
