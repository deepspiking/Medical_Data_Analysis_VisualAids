...
> 선생님 결정: stage(T/N)와 구성요소가 겹치므로 **개별 변수 중요도를 강조하는 구성요소 nomogram을 primary**로.
> 복합 병기(mTstage·mNstage) 버전은 supplement(`nomogram_*_stage.png`; DSS 0.859 / OS 0.803 / PFS 0.718 / LRRFS 0.697).
> 개념·읽는 법(변수 중요도=축 길이): `nomogram_해석_가이드.md`. DSS가 가장 강하고 LRRFS가 가장 약함(난이도 차).
