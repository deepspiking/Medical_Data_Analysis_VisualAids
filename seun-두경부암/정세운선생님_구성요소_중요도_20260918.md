...
2. **그래서 stage를 전부 빼고 구성요소만 넣어 확인** → **PD_01vs2가 4개 endpoint 중 3개에서 1위,
...
- 구성요소 9개: `tumor size(cm)`, `DOI(mm)`, `PD_01vs2`, `bone invasion`, `depth of bone inv.`,
...
- **PD_01vs2가 가장 강력한 단일 예후 구성요소** → **수정 T staging(PD-high를 mT4로 상향)의 근거를
...
> 구성요소를 직접 모델링하면 **PD_01vs2가 가장 중요한 예후인자**로 도출되며(4개 endpoint 모두),
