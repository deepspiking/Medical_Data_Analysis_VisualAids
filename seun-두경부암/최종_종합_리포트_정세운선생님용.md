...
| **개별 환자 예후 예측도구로 쓸 수 있나?** | ✅ Nomogram 4종 제공 | DSS **0.859** / OS **0.803** / PFS **0.718** / LRRFS **0.697** — §7 |
...
- mTstage가 size·DOI·PD의 함수이므로 **구성요소를 중복 기재하지 않고 복합 병기 축만 사용**(선생님 지적 반영;
  분해 모델 대비 CV C-index 동등~우수). 변수 영향력 해석(축 길이)과 개념은 `nomogram_해석_가이드.md` 참조.
