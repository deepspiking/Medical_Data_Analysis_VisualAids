...
| **개별 환자 예후 예측도구로 쓸 수 있나?** | ✅ Nomogram 4종 제공 | 주요변수 5개: DSS **0.869** / OS **0.805** / PFS **0.726** / LRRFS **0.718** — §7 |
...
- 선생님 결정: **주요변수 5개(PD·deposit·DOI·size·bilateral) nomogram을 primary**로,
  **복합 병기(mTstage·mNstage) nomogram을 본문에 동반**. 해석(축 길이)=`nomogram_해석_가이드.md`.
- **DSS가 가장 강하고(C 0.87), LRRFS가 가장 약함(C 0.72)** — endpoint 난이도 차이.
